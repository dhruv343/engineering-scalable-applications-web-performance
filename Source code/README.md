...
📎 *See **`../Research Paper/Research Paper.pdf`** (submission package root).*
...
cd "engineeringScalableApplicationsWithOptimizedWebPerf_2210991507_2210990446_2210991258_2210991544/Source code"
npm install
npm run dev
```
